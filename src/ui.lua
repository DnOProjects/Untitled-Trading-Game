...
function initUI()
	...
	addPrint({1, 2}, "Tropical Trader", 0, 50, 1920, 150, 0, 0.1, 0.15, 1, "center")
...
function drawButtons()
	for i, button in pairs(buttons) do
	    if (button.page == currentPage) then
			...
			love.graphics.setFont(love.graphics.newFont("fonts/"..button.font..".ttf", button.textSize))
...
function drawSliders()
	for i, slider in pairs(sliders) do
		if (slider.page == currentPage) then
		    ...
		    love.graphics.setFont(love.graphics.newFont("fonts/"..slider.font..".ttf", slider.textSize))
...
function drawPrints()
	for i, printText in pairs(prints) do
		if (logic.inList(currentPage, printText.pages)) then
			love.graphics.setFont(love.graphics.newFont("fonts/"..printText.font..".ttf", printText.textSize))
